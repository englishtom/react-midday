...
const App = () => {
    ...
    return (
        <div>
            <MiddayHeader className="fixed" options={options}>
                <a className="logo">My Logo</a>
            </MiddayHeader>
...
const App = () => (
    <div>
        <MiddayHeader className="fixed">
            <a className="logo">First Logo</a>
        </MiddayHeader>

        <MiddayHeader className="fixed" options={{sectionSelector: 'noon'}}>
            <a className="logo">Second Logo</a>
        </MiddayHeader>
        ...
        <MiddaySection sections={{midday: 'blue', noon: 'blue'}}>
